...
import com.itwill.matzip.dto.MenuToCreate;
...
public class AdminController {
    ...
    public ResponseEntity<String> addMenuToRestaurant(@RequestBody MenusToCreate menus, @PathVariable Integer restaurantId){
